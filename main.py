...
def dictionarize(term_list: list) -> dict:
    """Searches through a list of lists, adding counts of each term a returned dictionary.
    @param term_list: a list of lists, containing found terms.
    @return: a dictionary of term counts."""

    term_counts = {}

    for sublist in term_list:
        for term in sublist:
...
if __name__ == "__main__":
    ...
    print(dictionarize(resulting_list))
    indeed_driver.close()
